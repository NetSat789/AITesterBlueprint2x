...
#Agent2 - Root Cause Investigator(uses  Bug Triage output as context)
#Agent 3 - Test Recommendation Agent(uses both previous output)

#H ow to fetsch from jira
# Jira API/MCP
#  
...
def fetch_jira_ticket(bug_id):
    url = f"https://pqrs78901.atlassian.net/rest/api/3/issue/{bug_id}"
...
bug_report = fetch_jira_ticket("KAN-12")
print(bug_report)
